...
const Contact: React.FC<ContactProps> = ({ className }) => {
  ...
  return (
    // Outer container with left/right padding
    <div className="w-full pl-[4px] pr-[20px]">
      <div
        onClick={handleClick}
        className={`w-full h-[55px] relative cursor-pointer rounded-md overflow-hidden transition-colors duration-200 ${
          className || ""
        }`}
      >
        ...
        <div
          ...
          style={{
            backgroundColor: selected ? "#1E1F22" : "transparent",
          }}
        ></div>

        {/* Content */}
        <div className="relative flex items-center w-full h-full pl-[12px] pr-[12px] hover:bg-[#1A1B1F] transition-colors duration-200">
          {/* Avatar container */}
          ...
          {/* Text container */}
          <div className="ml-3 flex flex-col justify-center flex-1 overflow-hidden">
            {/* Title */}
            <span
